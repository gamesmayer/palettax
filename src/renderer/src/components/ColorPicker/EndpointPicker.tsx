  ...
  return (
    <div className="endpoint-picker__field">
      ...
      <div className="endpoint-picker__mode-toggle">
        <Button
          className={
            mode === 'palette' ? 'endpoint-picker__mode-btn endpoint-picker__mode-btn--active' : 'endpoint-picker__mode-btn'
          }
        ...
        <Button
          className={
            mode === 'new' ? 'endpoint-picker__mode-btn endpoint-picker__mode-btn--active' : 'endpoint-picker__mode-btn'
          }
